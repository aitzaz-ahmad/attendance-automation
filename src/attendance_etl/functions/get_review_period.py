...
def get_next_review_period(last_review_period):
    ...
    sheetname, review_month = calculate_next_review_period(last_review_month, review_period_sheet)
    print("next review month: {}\nsheet name: {}".format(review_month, sheetname))
    ...
    try:
        ...
        print("ERROR: Unable to find review periods for the year " + sheetname + " in the review period spreadsheet.")
